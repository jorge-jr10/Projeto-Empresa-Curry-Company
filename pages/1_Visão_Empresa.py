...
with tab1:
    ...
    with st.container():
        ...
        with col1:
            ...
            st.markdown('#### Qtd de pedidos por condições de tráfego')
            st.plotly_chart( fig, use_container_width=True)              
    
        with col2:
            st.markdown('#### Qtd de pedidos por cidade e condições de tráfego')
...
with tab3:
    st.markdown('#### Diferentes locais de entrega segmentados por cidade e condições de tráfego')
    country_maps(df1)
